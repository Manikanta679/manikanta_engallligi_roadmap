...
const seeds: CompanySeed[] = [
  ...
  },
  {
    ...
    headquartersHighlight: "Amsterdam 🇳🇱 Target destination — digital freight startup",
    website: "https://www.flexport.com",
    domain: "flexport.com",
    tags: ["nl-hub", "visa-friendly"],
    brief:
      "Amsterdam hub startup/scale node. Digital freight forwarder — same problem family as sennder / Forto.",
    europeFocus:
      "Later NL door. English. Not a Semester 3 move.",
    sources: [
      { title: "Official site", url: "https://www.flexport.com" },
      { title: "Careers", url: "https://www.flexport.com/careers/" },
    ],
  ...
  },
  {
    ...
    headquarters: "Düsseldorf / Cologne, Germany",
    headquartersHighlight: "Rhine belt Target NRW — data consultancy",
    website: "https://www.rheindata.com",
    domain: "rheindata.com",
    tags: ["nrw-hub", "visa-friendly"],
    brief:
      "Rhine-belt data & analytics delivery shop. More hats, faster learning than a DAX Werkstudent.",
    europeFocus:
      "Düsseldorf / Cologne English-possible boutique next to Cognigy / DeepL clients.",
    sources: [
      { title: "Official site", url: "https://www.rheindata.com" },
    ],
    imageHint: "data consultancy",
  },
  {
    name: "Ubirch",
    sector: "AI/Software",
    ...
    headquartersHighlight: "Cologne Target NRW — data integrity / IoT trust",
    website: "https://ubirch.com",
    domain: "ubirch.com",
    tags: ["nrw-hub", "ai-focus"],
    brief:
      "Cologne-area data-integrity / IoT trust startup. Small team, high ownership.",
    europeFocus:
      "Cologne Tier 3 next to DeepL / 1NCE. Verify live hiring before I apply.",
    sources: [
      { title: "Official site", url: "https://ubirch.com" },
    ],
    imageHint: "iot trust",
  },
  {
    ...
    headquartersHighlight: "Dortmund Target NRW — IML spin-off",
    website: "https://www.motionminers.com",
    domain: "motionminers.com",
    tags: ["nrw-hub", "ai-focus", "visa-friendly"],
    brief:
      "Fraunhofer IML spin-off. Warehouse motion / process analytics — direct Problem B. English possible on the tech side.",
    europeFocus:
      "Dortmund research-to-product door. Best Ruhr English-possible startup next to IML.",
    sources: [
      { title: "Official site", url: "https://www.motionminers.com" },
      { title: "Careers", url: "https://www.motionminers.com/career" },
    ],
    imageHint: "warehouse motion",
  },
  {
    name: "Fraunhofer IML",
    ...
    locations: ["Dortmund"],
    headquarters: "Dortmund, Germany",
    headquartersHighlight: "Dortmund Target NRW — logistics research",
    website: "https://www.iml.fraunhofer.de",
    domain: "iml.fraunhofer.de",
    tags: ["nrw-hub", "visa-friendly"],
    brief:
      "Logistics research institute. Thesis / research-assistant door, not a classic job title. Papers and some groups in English.",
    europeFocus:
      "Dortmund thesis partner next to ScaDS.AI — I do not treat Leipzig as the only research city.",
    sources: [
      { title: "Official site", url: "https://www.iml.fraunhofer.de" },
      { title: "Careers", url: "https://www.iml.fraunhofer.de/en/the_fraunhofer_iml/career.html" },
    ],
    imageHint: "logistics research",
  },
  {
    name: "DeepJudge",
    sector: "AI (legal)",
    ...
    headquartersHighlight: "Zurich 🇨🇭 Target destination — legal AI",
    website: "https://www.deepjudge.ai",
    domain: "deepjudge.ai",
    tags: ["zurich-hub", "visa-friendly", "ai-focus"],
    brief:
      "Zurich legal-AI startup. Document AI, not chatbot demos. English product culture.",
    europeFocus:
      "Zurich Tier 3 — Problem B/C documents. Hard sponsor bar.",
    sources: [
      { title: "Official site", url: "https://www.deepjudge.ai" },
    ],
    imageHint: "legal document ai",
  },
  {
    name: "LatticeFlow",
    ...
    locations: ["Zurich"],
    headquarters: "Zurich, Switzerland",
    headquartersHighlight: "Zurich 🇨🇭 Target destination — model governance",
    website: "https://www.latticeflow.ai",
    domain: "latticeflow.ai",
    tags: ["zurich-hub", "visa-friendly", "ai-focus"],
    brief:
      "Model-quality / governance startup. EU AI Act story. English-first.",
    europeFocus:
      "Zurich AI-governance Tier 3 next to Lakera / Swiss Re.",
    sources: [
      { title: "Official site", url: "https://www.latticeflow.ai" },
      { title: "Careers", url: "https://www.latticeflow.ai/careers" },
    ],
    imageHint: "model governance",
  },
  {
    name: "ONIQ",
    ...
    locations: ["Cologne"],
    headquarters: "Cologne, Germany",
    headquartersHighlight: "Cologne Target NRW — manufacturing startup",
    website: "https://oniq.com",
    domain: "oniq.com",
    tags: ["nrw-hub", "ai-focus"],
    brief:
      "Cologne manufacturing startup. Process mining / digital value-stream for plants — Celonis-style, local. Verify live hiring.",
    europeFocus:
      "Cologne Tier 3 startup next to Ford / Deutz. Same problem family as Celonis without a Munich move.",
    sources: [
      { title: "Official site", url: "https://oniq.com" },
      { title: "Careers", url: "https://oniq.com/en/career" },
    ],
    imageHint: "manufacturing process mining",
  },
  {
    name: "Wakeline",
    sector: "AI/Energy",
    ...
    headquartersHighlight: "Düsseldorf Target NRW — energy-forecast startup",
    website: "https://wakeline.ai",
    domain: "wakeline.ai",
    tags: ["nrw-hub", "ai-focus", "visa-friendly"],
    brief:
      "Düsseldorf startup. Live energy-market forecasting. Closest local cousin of my ICE delay / time-series story. English or German. Tiny team — verify roles.",
    europeFocus:
      "Düsseldorf Tier 3 startup next to Uniper. Pre-seed; I treat it as a research / intern watch, not a 2027 volume employer.",
    sources: [
      { title: "Official site", url: "https://wakeline.ai" },
    ],
    imageHint: "energy forecast",
  },
  {
    name: "Logistikbude",
    sector: "AI/Logistics",
    locations: ["Dortmund"],
    headquarters: "Dortmund, Germany",
    headquartersHighlight: "Dortmund Target NRW — IML spin-off startup",
    website: "https://logistikbude.com",
    domain: "logistikbude.com",
    tags: ["nrw-hub", "ai-focus"],
    brief:
      "Dortmund startup from Fraunhofer IML. Load-carrier / pallet tracking — Problem B next to MotionMiners / duisport.",
    europeFocus:
      "Ruhr Tier 3 startup. Same research-to-product door as MotionMiners. Verify live hiring before I apply.",
    sources: [
      { title: "Official site", url: "https://logistikbude.com" },
      { title: "Careers", url: "https://join.com/companies/logistikbude" },
    ],
    imageHint: "load carrier tracking",
  },
  {
    name: "Arqh",
    sector: "AI/Logistics",
    locations: ["Zurich"],
    headquarters: "Zurich, Switzerland",
    headquartersHighlight: "Zurich 🇨🇭 Target destination — freight-planning startup",
    website: "https://arqh.ai",
    domain: "arqh.ai",
    tags: ["zurich-hub", "visa-friendly", "ai-focus"],
    brief:
      "Zurich startup. AI planning for road freight — decision intelligence, not a chatbot demo. English. Hard sponsor bar.",
    europeFocus:
      "Zurich Tier 3 logistics startup next to Verity. Strongest Swiss freight-decision name after K+N.",
    sources: [
      { title: "Official site", url: "https://arqh.ai" },
      { title: "Tech Funding News — pre-seed", url: "https://techfundingnews.com/swiss-ai-startup-arqh-38m-pre-seed-logistics-ai/" },
    ],
    imageHint: "freight planning",
  },
  {
    name: "Aisot",
    sector: "AI/FinTech",
    locations: ["Zurich"],
    headquarters: "Zurich, Switzerland",
    headquartersHighlight: "Zurich 🇨🇭 Target destination — portfolio-intel startup",
    website: "https://www.aisot.com",
    domain: "aisot.com",
    tags: ["zurich-hub", "visa-friendly", "ai-focus"],
    brief:
      "ETH-rooted startup. Portfolio intelligence for asset managers. Watch for 2028–30, not a first job.",
    europeFocus:
      "Zurich Tier 3 startup next to Unique / Julius Baer. Sponsor required.",
    sources: [
      { title: "Official site", url: "https://www.aisot.com" },
    ],
    imageHint: "portfolio intelligence",
  },
  {
    name: "kausable",
    ...
    headquartersHighlight: "Heidelberg — forecasting startup",
    website: "https://www.kausable.ai",
    domain: "kausable.ai",
    tags: ["ai-focus"],
    brief:
      "Heidelberg startup. Rare-event / forecasting models (TipPFN). Energy + medicine. Tiny team — thesis / research watch.",
    europeFocus:
      "Rhine-Neckar Tier 3 startup next to Aleph Alpha / SAP. Verify live hiring. Company map only.",
    sources: [
      { title: "Official site", url: "https://www.kausable.ai" },
      { title: "HTGF — seed", url: "https://www.htgf.de/en/kausable-seed-round/" },
    ],
    imageHint: "forecasting startup",
  },
  {
    name: "Daedalus",
    sector: "AI/Industrial",
    ...
    headquartersHighlight: "Karlsruhe — manufacturing startup",
    website: "https://daedalus.de",
    domain: "daedalus.de",
    tags: ["ai-focus"],
    brief:
      "Karlsruhe startup. AI + CNC / precision manufacturing. Problem B on the shop floor. Verify live hiring.",
    europeFocus:
      "Karlsruhe Tier 3 startup next to EnBW / INIT. Company map only — not a Target Location city.",
    sources: [
      { title: "Official site", url: "https://www.daedalus.de" },
      { title: "Careers", url: "https://webflow.daedalus.de/karriere" },
    ],
    imageHint: "cnc manufacturing",
  },
];
